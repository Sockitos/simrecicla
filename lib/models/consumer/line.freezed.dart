...
class _$_Line extends _Line {
  ...
  @override
  String toString() {
    return 'Line(papel: $papel, cartao: $cartao, ecal: $ecal, filmePlastico: $filmePlastico, pet: $pet, pead: $pead, plasticosMistos: $plasticosMistos, metaisFerrosos: $metaisFerrosos, metaisNaoFerrosos: $metaisNaoFerrosos, vidro: $vidro, eps: $eps)';
  }
