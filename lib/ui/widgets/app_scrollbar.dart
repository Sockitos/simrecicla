...
class ScrollbarPainter extends ChangeNotifier implements CustomPainter {
  ...
  void update(
    ...
    bool needPain(ScrollMetrics? metrics) =>
        metrics != null && metrics.maxScrollExtent > metrics.minScrollExtent;
    if (!needPain(oldMetrics) && !needPain(metrics)) return;
...
class AppScrollbar extends StatefulWidget {
  const AppScrollbar({
    ...
    this.thickness = 8,
    this.thumbColor = AppColors.lightGreen,
    this.trackColor = AppColors.grey4,
    ...
    this.mainAxisMargin = 30,
    this.crossAxisMargin = 12,
  ...
  @override
  AppScrollbarState<AppScrollbar> createState() =>
      AppScrollbarState<AppScrollbar>();
}

class AppScrollbarState<T extends AppScrollbar> extends State<T>
