      ...
      answers: [
        ...
        Answer(
          ...
          vidro: AnswerComponent(
            value: -3,
            recommendation:
                'Para que a embalagem possa ser colocada no ecoponto adequado, é fundamental que a mesma contenha o ícone desse ecoponto. Nas situações de presença de componentes de materiais diferentes, superiores a 5 cm e separáveis, deve informar-se o consumidor sobre o ecoponto onde deve ser colocado cada componente. Caso o destino correto da embalagem não seja o ecoponto, essa informação deverá ser igualmente indicada através do ícone adequado para o efeito, conforme as regras estabelecidas https://www.pontoverde.pt/1_4_simbolos_e_icones.php. Para mais informações consultar https://www.pontoverdelab.pt/ecodesign/desenhar-para-reciclar/torne-a-sua-embalagem-mais-reciclavel/.',
          ),
          aco: AnswerComponent(
            value: -3,
            recommendation:
